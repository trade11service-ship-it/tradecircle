      ...
      <section className="tc-section">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="tc-card p-8 space-y-5 text-[15px] text-muted-foreground leading-relaxed">
            <p>TradeCircle provides a technology platform that allows users to discover and subscribe to SEBI-registered investment advisors.</p>
            <ol className="list-decimal list-inside space-y-3">
              <li>Users subscribe to advisors voluntarily.</li>
              <li>TradeCircle does not participate in trading activity or provide financial advice.</li>
              <li>Advisors are responsible for the signals and strategies they share with subscribers.</li>
              <li>TradeCircle does not guarantee profitability or trading outcomes.</li>
              ...
              <li>TradeCircle reserves the right to remove advisors or users who violate platform policies.</li>
            </ol>
          </div>
        </div>
      </section>
