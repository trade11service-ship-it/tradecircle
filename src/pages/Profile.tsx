      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              This request will be sent to the RA <span className="text-sky font-semibold">Circle</span> team for manual review. Your {deleteType === 'group' ? 'group' : 'account'} will not be deleted immediately.
            </DialogDescription>
          </DialogHeader>
