...
export default function Profile() {
  ...
  const getDeleteTemplate = () => {
    ...
    return `Dear RA Circle Team,\n\nI would like to request the deletion of my RA Circle account.\n\nName: ${profile?.full_name}\nEmail: ${profile?.email}\n\nReason: ${deleteReason || '(Please specify your reason)'}\n\nI understand that:\n- All my subscriptions and data will be removed\n- This process will be handled manually by the RA Circle team\n- This action cannot be undone once processed\n\nPlease review and process this request.\n\nRegards,\n${profile?.full_name}`;
  };
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              This request will be sent to the RA <span className="text-primary font-semibold">Circle</span> team for manual review. Your {deleteType === 'group' ? 'group' : 'account'} will not be deleted immediately.
            </DialogDescription>
          </DialogHeader>
