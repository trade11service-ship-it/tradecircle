...
export default function Profile() {
  ...
  const getDeleteTemplate = () => {
    ...
    return `Dear StockCircle Team,\n\nI would like to request the deletion of my StockCircle account.\n\nName: ${profile?.full_name}\nEmail: ${profile?.email}\n\nReason: ${deleteReason || '(Please specify your reason)'}\n\nI understand that:\n- All my subscriptions and data will be removed\n- This process will be handled manually by the StockCircle team\n- This action cannot be undone once processed\n\nPlease review and process this request.\n\nRegards,\n${profile?.full_name}`;
  };
