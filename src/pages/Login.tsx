          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-xl shadow-black/5">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Sign in to your <span className="font-bold text-foreground">RA <span className="text-emerald">Circle</span></span> account
              </p>
            </div>
            ...
            <Button
              variant="outline"
              className="mb-6 w-full gap-2 py-5 text-sm font-medium tc-btn-click rounded-xl"
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="email" value={email} onChange={e => setEmail(e.target.value)} required className="pl-10 h-11 rounded-xl tc-input-focus" placeholder="you@example.com" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} required className="pl-10 pr-10 h-11 rounded-xl tc-input-focus" placeholder="••••••••" />
            ...
            <div className="mt-6 space-y-2 text-center text-sm text-muted-foreground">
              <p>Don't have an account? <Link to="/register" className="font-medium text-primary hover:underline">Create Account</Link></p>
              <p>Want to join as advisor? <Link to="/advisor-register" className="font-medium text-primary hover:underline">Register as Advisor</Link></p>
            </div>
          </div>
        </div>
      </div>
