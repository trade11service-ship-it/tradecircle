    ...
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-16">
          <div className="rounded-2xl border border-border bg-card p-8 text-center max-w-md shadow-xl shadow-black/5">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-border bg-card p-8 shadow-xl shadow-black/5">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input value={form.fullName} onChange={e => setForm({ ...form, fullName: e.target.value })} required className="pl-10 h-11 rounded-xl tc-input-focus" placeholder="Your full name" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} required className="pl-10 h-11 rounded-xl tc-input-focus" placeholder="you@example.com" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type={showPassword ? 'text' : 'password'} value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} required minLength={6} className="pl-10 pr-10 h-11 rounded-xl tc-input-focus" placeholder="Min 6 characters" />
            ...
            <Button
              variant="outline"
              className="w-full gap-2 py-5 text-sm font-medium tc-btn-click rounded-xl"
