...
import { Shield, Search, ArrowRight, TrendingUp, Users, BadgeCheck, Activity, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-full h-full flex flex-col bg-background">
      ...
      <div className="border-t bg-muted px-4 py-3 text-center">
        <p className="text-[11px] text-muted-foreground">
          ...
          All advisors on RA Circle are SEBI registered. SEBI does not endorse any advisor's performance.
        </p>
      </div>
