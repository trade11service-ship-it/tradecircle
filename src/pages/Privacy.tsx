      ...
      <section className="tc-section">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="tc-card p-8 space-y-5 text-[15px] text-muted-foreground leading-relaxed">
            <p>StockCircle collects basic user information such as name, email address, and account details required to operate the platform.</p>
            ...
            <p>StockCircle does not sell user data to third parties.</p>
