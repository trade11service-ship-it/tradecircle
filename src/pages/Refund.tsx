      ...
      <section className="tc-section">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="tc-card p-8 space-y-5 text-[15px] text-muted-foreground leading-relaxed">
            <p>All advisor subscriptions on TradeCircle are <strong className="text-foreground">non-refundable</strong>.</p>
            ...
            <p>TradeCircle does not control the trading performance of advisors and therefore cannot guarantee results.</p>
